...
export default function AdminAccountPage() {
  ...
  const accounts = [
    ...
    {
      id: "5",
      email: "recruiter4@skyshi-hub.com",
      name: "Alice Williams",
      status: "active",
    ...
    {
      id: "6",
      email: "recruiter5@skyshi-hub.com",
      name: "Charlie Brown",
      status: "active",
    ...
    {
      id: "7",
      email: "recruiter6@skyshi-hub.com",
      name: "Diana Prince",
      status: "inactive",
    ...
    {
      id: "8",
      email: "recruiter7@skyshi-hub.com",
      name: "Edward Norton",
      status: "active",
    ...
    {
      id: "9",
      email: "recruiter8@skyshi-hub.com",
      name: "Fiona Green",
      status: "active",
    ...
    {
      id: "10",
      email: "recruiter9@skyshi-hub.com",
      name: "George Miller",
      status: "inactive",
